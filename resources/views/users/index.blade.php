...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            ...
            <a class="btn btn-primary btn-icon-text btn-sm" href="{{ route('users.create')}}"><i
                    class="ti-plus btn-icon-prepend icon-sm"></i>New User</a>
            <a class="btn btn-primary btn-icon-text btn-sm" href="{{ route('importfiles')}}"><i
                    class="ti-download btn-icon-prepend icon-sm"></i>Import New User</a>
