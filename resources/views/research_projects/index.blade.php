...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            ...
            <a class="btn btn-primary btn-menu btn-icon-text btn-sm mb-3"
                href="{{ route('researchProjects.create') }}"><i class="mdi mdi-plus btn-icon-prepend"></i> ADD</a>
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('researchProjects.destroy',$researchProject->id) }}"
                                    method="POST">
                                    <ul>
